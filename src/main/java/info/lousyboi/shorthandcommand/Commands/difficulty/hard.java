...
public class hard implements CommandExecutor, Listener {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args){
        ...
        if(sender instanceof Player){
            ...
            if (p.hasPermission("shorthandCommands.difficulty")){
                p.getLocation().getWorld().setDifficulty(Difficulty.HARD);
                p.sendMessage(ChatColor.BLUE + "[SC] " + ChatColor.GREEN + "World Difficulty set to " + ChatColor.YELLOW + "HARD");
            }
            else {
